...
export default function ForgotPassword(){
    ...
    const handleEmailSubmit = async (e)=>{
        ...
        try{
            // console.log("hi")
            await axios.post(`${import.meta.env.VITE_BACKEND_URL}/api/forgotPassword`, {email : email})
                .then(()=>{
    ...
    const handleOtpVerification = async (e)=>{
        ...
        try{
            await axios.post(`${import.meta.env.VITE_BACKEND_URL}/api/verifyOtp`, {email : email, otp : otp})
                .then(()=>{
    ...
    const handlePasswordReset = async (e)=>{
        ...
        try{
            await axios.post(`${import.meta.env.VITE_BACKEND_URL}/api/resetPassword`, {email : email, password : pass})
                .then(()=>{
        ...
        <h1 className="absolute top-40 text-4xl font-serif italic text-center">
            ...
            <div className="bg-zinc-800 p-8 rounded-lg shadow-lg w-[90%] sm:w-[400px] flex flex-col gap-6 items-center">
                ...
                <div className="text-base font-medium font-sans text-center text-gray-300">
                    <span className="block">Account's Email:</span>
                    <span className="block text-sm text-white font-normal">{email}</span>
                </div>
